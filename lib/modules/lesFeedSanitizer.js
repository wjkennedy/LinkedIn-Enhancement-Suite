...
module.onSaveSettings = changedSettings => {
	if (changedSettings.readingDensity || changedSettings.autoExpand) {
...
function mountControl() {
	...
	if (!(densitySelect instanceof HTMLSelectElement) || !(expandToggle instanceof HTMLInputElement) || !(nightModeToggle instanceof HTMLInputElement)) return;
...
function expandReadableContent(root: ParentNode) {
	if (!module.options.autoExpand.value) return;
